...
| FR-040～045 | home/statistics/budget usecases | 聚合 projections、budgets | 汇总对账、月边界、下钻、预算阈值 |
| FR-050～055 | backup、export、SAF UI | `.pbk` v1、JSON Schema、CSV v1 | 黄金 fixture、恶意输入、往返恢复 |
